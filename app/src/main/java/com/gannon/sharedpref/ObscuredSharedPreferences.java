...
public class ObscuredSharedPreferences implements SharedPreferences {
     ...
     * If you don't want to use the default_img per-device key for example
     * @param key
     */
     ...
     * If you don't want to use the default_img per-device code for example
