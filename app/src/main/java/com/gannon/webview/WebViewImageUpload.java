...
public class WebViewImageUpload extends SuperCompatActivity {

    private static final String TAG = WebViewImageUpload.class.getSimpleName();
...
//        }
        ...
        if (Build.VERSION.SDK_INT >= 23 && (
            ...
            ActivityCompat.requestPermissions(WebViewImageUpload.this,
        ...
        final ProgressDialog progressBar = new ProgressDialog(WebViewImageUpload.this);
        ...
        if (checkInternet()) {
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                ...
                public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                    ...
                    i.setType("*/*");
                    WebViewImageUpload.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), FCR);
                }
                ...
                public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
                    ...
                    i.addCategory(Intent.CATEGORY_OPENABLE);
                    i.setType("*/*");
                    WebViewImageUpload.this.startActivityForResult(
                ...
                public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                    ...
                    i.addCategory(Intent.CATEGORY_OPENABLE);
                    i.setType("*/*");
                    WebViewImageUpload.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), WebViewImageUpload.FCR);
                }
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(WebViewImageUpload.this.getPackageManager()) != null) {
                        File photoFile = null;
                        try {
